...
<?php include('includes/slider.php');?>
    ...
    <div class="container">
        ...
        <h1 class="my-4" style="padding-top: 7%">Welcome to Blood Donation System</h1>
        ...
        <!-- Portfolio Section -->
        <h2 style="padding-bottom: 1% ">Who can give blood</h2>
        <p>Most people can give blood. You can give blood if you:</p>
        <ul>
            <li>are fit and healthy</li>
            <li>weight between 7 stone 12 lbs and 25 stone, or 50kg and 160kg</li>
        ...
        <h2 style="padding-bottom: 3% ">Available Donars</h2>
